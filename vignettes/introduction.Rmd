...
- they have a fixed set of allowed values called 'levels' (like factors)
- they can store alternative values for each level; you can switch back and forth between alternatives. Alternatives can be of any vector type
...
my_weekend_days_en <- mydays_en[as.character(day_type)=='weekend']
my_weekend_days_en
```
