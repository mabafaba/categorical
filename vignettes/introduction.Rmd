...
mydays_en
```
You can see that the levels remain untouched.
...
let's subset the vector to only keep the week days, and show their german labels:

```{r}

my_week_days <- alternate(mydays_en,'day_type')
my_week_days

my_week_days <- my_week_days[my_week_days!='weekend']
my_week_days

my_week_days <- alternate(my_week_days, 'labels_german')
my_week_days
```
